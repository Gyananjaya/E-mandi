        ...
        return (
            ...
            {/* filter and product mapping is not provided here yet */}
                <div className="buttons d-flex justify-content-center mb-5 pb-5" >
                    ...
                    <button className='btn btn-outline-dark me-2'onClick={()=>filterProduct("vegitable")}>Vegitable</button>
                    <button className='btn btn-outline-dark me-2'onClick={()=>filterProduct("grains")}>Grains</button>
                </div>
                {
